...
以下产物的单一配方前后级衍生物资（包括合成、烧炼、生长等衍生）均不在此列出，如金锭在此列出等价于能够高效获取金粒和金块，但这两种物资不会在此列出。
...
**使用说明**
- 站在挂机点，喝下不祥之瓶，处理袭击即可，袭击间隔需要将溢出的弩、铁斧、鞍手动销毁

注意，建议使用高等级附魔的武器尽快处死唤魔者，避免恼鬼的生成。
...
**使用说明**
- 站在挂机点，使用包含抢夺的武器进行攻击盔甲架即可。
- 建议将背包提前填充掉落物，避免被药水污染。无需担心饱食度问题，挂机点信标的生命回复速度大于饥饿生命损失速度。
...
**使用说明**
- 站在挂机点，使用包含抢夺的武器进行攻击僵尸猪人即可。
- 建议将背包提前填充掉落物，避免被金剑污染。无需担心饱食度问题，挂机点信标的生命回复速度大于饥饿生命损失速度。
...
**使用说明**
- 站在挂机点，使用包含抢夺的武器进行攻击凋零骷髅即可。
- 建议将背包提前填充掉落物，避免被石剑污染。无需担心饱食度问题，挂机点信标的生命回复速度大于饥饿生命损失速度。
...
## 远古残骸盾构机
一台建设在下界世界y=10的弱加载盾构机，能够在2.6秒清空一个区块，能够高效获取远古残骸
- **产出：** **远古残骸(100/h)**
- **输入：** 抗火药水
- **坐标：** 
- **挂机构型：** 主动式
